...
if __name__ == "__main__":
  ...
  no_of_frames_to_return = 2

  #Input Video directory path
  #All .mp4 and .mov files inside this directory will be used for keyframe extraction)

  videos_dir_path = r"C:\Users\Toan\OneDrive\Desktop\YouTube_DataSet_Annotated\models\static"

  diskwriter = KeyFrameDiskWriter(location="selectedframes")

  # videos_dir_path = r"C:\Users\Toan\OneDrive\Desktop\YouTube_DataSet_Annotated\models\static"

  # diskwriter = KeyFrameDiskWriter(location="selectedframes_fromstatic")
